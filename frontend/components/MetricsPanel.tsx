...
export default function MetricsPanel({ metrics }: Props) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
      {/* Total Sessions */}
      <div className="bg-white rounded-xl border border-nexus-200 p-4">
        <div className="text-2xl font-bold text-nexus-800">
      ...
      {/* Agents breakdown */}
      <div className="col-span-2 md:col-span-4 bg-white rounded-xl border border-nexus-200 p-4">
